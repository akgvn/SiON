            ...
            if (data) {
                ...
                if (driver) {
                    ...
                    for (i=0; i<waveTables.length;    i++) {
                        if (waveTables[i]) {
                            SiOPMTable._instance._sion_internal::registerWaveTable(waveTableOffset+i, new SiOPMWaveTable().copyFrom(waveTables[i]).wavelet); // TODO(AKG): Not sure if this is correct
                        }
                    }
